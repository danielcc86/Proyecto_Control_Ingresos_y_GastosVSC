...
namespace ControlIngresosGastos.Controllers
{
    public class IngresoGastoController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? mes, int? anio)
        {
            ...
            var applicationDbContext = _context.IngresosGastos.Include(i => i.Categoria)
        ...
        {
            if (id == null || _context.IngresosGastos == null)
            {
                return NotFound();
            }

            var ingresoGasto = await _context.IngresosGastos
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ingresoGasto = await _context.IngresosGastos.FindAsync(id);
            if (ingresoGasto == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.IngresosGastos == null)
            {
                return Problem("Entity set 'ApplicationDbContext.IngresosGastos'  is null.");
            }
            var ingresoGasto = await _context.IngresosGastos.FindAsync(id);
            if (ingresoGasto != null)
            {
                _context.IngresosGastos.Remove(ingresoGasto);
            }
        ...
        {
          return (_context.IngresosGastos?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
